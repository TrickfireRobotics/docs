                ...
                <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-2">
                    {repos.map((repo) => (
                        <Link
                            key={repo.id}
                            href={`/${repo.id}`}
                            className="group relative flex h-[6.5rem] flex-col gap-1 rounded-lg border border-fd-border border-l-4 border-l-fd-primary/40 bg-fd-card px-6 py-5 transition-colors hover:border-l-fd-primary hover:bg-fd-accent/40"
                        >
