...
| Component                         | Guide                                        |
| --------------------------------- | -------------------------------------------- | --- |
| Debian server with nginx          | [Server Setup](./server-setup.mdx)           |
| Cloudflare tunnel                 | [Cloudflare Tunnel](./cloudflare-tunnel.mdx) |
...
| Task                | How                                                       |
| ------------------- | --------------------------------------------------------- |
| Update cli          | Push to `main` in this repo - `deploy.yml` handles it     |
